...
func (c *Client) CreateSecretManager(secretManager ResourceWrapper) (*ResourceWrapper, error) {
	...
	resp, err := c.MakeCallWithQueryParams(http.MethodPost, endpointSecretManagers, "baseresource",secretManagerJSON, c.config.Params)
	if err != nil {
...
func (c *Client) ReadSecretManagers() (*ResourcesWrapper, error) {
	...
	resp, err := c.MakeCall(http.MethodGet, endpointSecretManagers, "baseresource",nil)
	if err != nil {
...
func (c *Client) UpdateSecretManager(secretManagerId string, secretManager ResourceWrapper) (*ResourceWrapper, error) {
	...
	reqURL := fmt.Sprintf(endpointSecretManagers+"/%s", url.PathEscape(secretManagerId))
	resp, err := c.MakeCallWithQueryParams(http.MethodPut, reqURL, "baseresource",secretManagerJSON, c.config.Params)
	if err != nil {
